...
model TestDynamicActInhRevKinetic
  ...
  Internal.AssertContinuousTrajectory checkv(MaxAccErr = 1e-3, name = "Dynamic ActInhRevKinetic v") annotation (
    Placement(visible = true, transformation(origin = {42, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
Internal.AssertContinuousTrajectory checkS(MaxAccErr = 1e-3, name = "Dynamic ActInhRevKinetic S") annotation (
    Placement(visible = true, transformation(origin = {38, 64}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
Internal.AssertContinuousTrajectory checkP(MaxAccErr = 1e-3, name = "Dynamic ActInhRevKinetic P") annotation (
    Placement(visible = true, transformation(origin = {36, -78}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Internal.SAIvP_rev SR1(
    I=I,
    kI=kI,
    A=A,
    kA=kA,
    ...
    kmS=kmS,
    vbwd=vbwd,
    kmP=kmP) annotation (Placement(visible=true, transformation(
        origin={-56,32},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  GenKinetics.UnitTests.Internal.OOSAIvP_rev SR2(
    I0=I,
    kI=kI,
    A0=A,
    kA=kA,
...
end TestDynamicActInhRevKinetic;
