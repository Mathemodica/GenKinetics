within GenKinetics.UnitTests.Dynamic.deprecated;
model TestDynamicRevKinetic
  ...
  Validate check(MaxAccErr=1e-3, name="Dynamic Reversible Kinetic") annotation (
     Placement(visible=true, transformation(
        origin={42,0},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  GenKinetics.UnitTests.Internal.Dynamic.deprecated.SvP_rev SR1(
    S0=S0,
    vfwd=vfwd,
    vbwd=vbwd,
    kmS=kmS,
