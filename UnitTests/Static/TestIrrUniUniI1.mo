...
model TestIrrUniUniI1
  ...
  Validate checkv(MaxAccErr=1e-3, name="Static IrrUniUniI1 v") annotation (
      Placement(visible=true, transformation(
        origin={42,0},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Validate checkS(MaxAccErr=1e-3, name="Static IrrUniUniI1 S") annotation (
      Placement(visible=true, transformation(
        origin={38,64},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Validate checkP(MaxAccErr=1e-3, name="Static IrrUniUniI1 P") annotation (
      Placement(visible=true, transformation(
        origin={36,-78},
        extent={{-10,-10},{10,10}},
        rotation=0)));
