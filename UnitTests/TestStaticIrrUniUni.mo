...
model TestStaticIrrUniUni
  ...
  Internal.OOSvP_static2 SR2(km = km, S0 = S0, vfwd = vfwd) annotation (
    Placement(visible = true, transformation(origin = {-46, -36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Internal.AssertContinuousTrajectory check(MaxAccErr=1e-3, name="Static Node")
