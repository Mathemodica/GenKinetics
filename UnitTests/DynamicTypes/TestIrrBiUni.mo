...
model TestIrrBiUni "Test S1 + S2 => P"
  ...
  GenKinetics.UnitTests.Validate check1(MaxAccErr=1e-3, name=
        "DynamicTypes IrrBiUni S1 + S2 => P") annotation (Placement(visible=
          true, transformation(
        origin={46,-60},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  OOModels.S1S2vP SR1(
    ...
    vfwd=vfwd,
    kmS1=kmS1,
    kmS2=kmS2) "Simple Reaction S1 + S2 => P" annotation (Placement(visible=true,
        transformation(
        origin={-34,50},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Internal.Explicit.S1S2vP SR2(
    ...
    kmS2=kmS2) "Explicit Simple Reaction S1 + S2 => P" annotation (Placement(
        ...
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Validate check2 annotation (Placement(visible=true, transformation(
        origin={50,58},
        extent={{-10,-10},{10,10}},
        rotation=0)));
equation
