...
package Structure
  ...
  partial model ReactionStructure "The structure of a reaction reversibility, molecularity and order"
    ...
    replaceable class Reversibility = Reversible.ReactionReversibility constrainedby Reversible.ReactionReversibility;
    extends Reversibility;
  
    replaceable class Dimensionality = Dynamic.Dimension.ReactionDimension constrainedby Dynamic.Dimension.ReactionDimension;
    extends Dimensionality;
  
  end ReactionStructure;

  partial model StrUniUni "Structure Uni Uni "
    extends ReactionStructure(redeclare final class Dimensionality = Dimension.UniUni);
  end StrUniUni;
