...
package Examples
  ...
  model SpirallusLinLog "An abstraction of the TCA cycle with dynamic arbitrary number of connections"
    ...
    ReferencedNode F(c_0 = 0.1,c_steady = 0.97);
    InhKinetic v4(NS = 1, NP = 2, NI = 1, S0 = {D.c_steady} , P0 = {E.c_steady,F.c_steady} , I0 = {C.c_steady} , alpha = {1.23}, theta = {0.33,1.34} , delta = {-1.2}, v_steady = 0.25);
    Kinetic v6(NS = 1, NP = 1, S0 = {E.c_steady}, P0 = {Eex.c_steady}, alpha = {0.45}, theta = {1.2} , v_steady = 0.25);
    ReferencedNode Eex(c_0 = 1, c_steady = 2.4);
    Kinetic v7(NS = 1, NP = 1, S0 = {F.c_steady} , P0 = {Fex.c_steady} , alpha = {0.56} , theta = {0.45} , v_steady = 0.48);
    ReferencedNode Fex(c_0 = 1, c_steady = 4.2);
  equation
// vupt
