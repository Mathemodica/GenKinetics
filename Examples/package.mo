...
package Examples
  ...
  model SpirallusStatic2 "Implementation of the Spiralus network using static connections"
    ...
    NodeElements.Static.FixedConcentrationNode Aex(c_0 = 1) annotation (
    ...
    Reactions.Convenience.Static2.RevUniUni v1(kmS = 0.1, Vfwdmax = 2.0, kmP = 0.3, Vbwdmax = 0.5) annotation (
    ...
    Reactions.Convenience.Static2.IrrUniUni irrUniUni(km = 3.0, Vmax = 2.0) annotation (
      Placement(transformation(extent = {{-118, -240}, {-98, -220}})));
  ...
  equation
    ...
    connect(F.rc3, irrUniUni.rc_S1) annotation (
      Line(points = {{-87.8, -190}, {-90, -190}, {-90, -208}, {-108, -208}, {-108, -218}, {-108, -218}, {-108, -220}, {-108, -220}}, color = {0, 0, 0}));
    connect(irrUniUni.rc_P1, Fex.rc2) annotation (
      Line(points = {{-108.2, -239.2}, {-108.2, -258}, {-108, -258}, {-108, -278}, {-138, -278}, {-138, -278.6}}, color = {0, 0, 0}));
