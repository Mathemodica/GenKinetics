...
model SpirallusStatic
  ...
  Reactions.Convenience.Explicit3.IrrUniUniI1 vupt(
    km=0.1,
    Vmax=1.0,
  ...
  Reactions.Convenience.Explicit3.RevUniUni v1(
    kmS=0.1,
    Vfwdmax=3.0,
    kmP=0.3,
    Vbwdmax=1.0)
  ...
  Reactions.Convenience.Explicit3.RevUniUni v5(
    kmS=1.0,
    Vfwdmax=2.0,
    kmP=1.0,
    Vbwdmax=0.5)
  ...
  Reactions.Convenience.Explicit3.IrrBiUni v2(
    km1=0.25,
    km2=2.0,
  ...
  Reactions.Convenience.Explicit3.IrrUniBiI1 v3(
    km=2.0,
    Vfwdmax=2.0,
  ...
  Reactions.Convenience.Explicit3.IrrUniBiI1 v4(
    km=0.1,
    Vfwdmax=3.0,
    ki=1.0) annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-82,-82})));
  Reactions.Convenience.Explicit3.IrrUniUni irrUniUni(km=3.0, Vmax=2.0)
  ...
  Reactions.Convenience.Explicit3.IrrUniUni v6(km=3.0, Vmax=2.0)
